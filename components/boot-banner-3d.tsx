...
function BootBanner3DScene() {
  ...
  useEffect(() => {
    ...
    const spotLight2 = new THREE.SpotLight(0xff1493, 1.5)
    spotLight2.position.set(-3, -2, 2)
    scene.add(spotLight2)

    const spotLight3 = new THREE.SpotLight(0xff00ff, 1.5)
...
export default function BootBanner3D() {
  return (
